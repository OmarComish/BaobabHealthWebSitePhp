...
<!-- BANNER -->
<div class="home">
    <div class="background_image_ourpeople"style="background-image: url(images/group-photo.jpg);"></div>
            ...
            <div class="row">
                <div class="col">
                    <div class="home_content">
                        <div class="home_title">Our people</div>
...
<div class="container">
            ...
            <div class="row">
                 <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="team-block">
                        <div class="team-img">
                            <img src="images/martha-kwataine.jpg" alt="">
                            <div class="team-content">
                                <h4 class="text-white mb0">Martha Kwataine</h4>
                                <p class="team-meta">- Executive Director</p>
                            </div>
                            <div class="overlay-x">
                                <div class="text">
                                    <h4 class="mb0 text-white">Martha Kwataine</h4>
                                    <p class="mb30 team-meta">- Executive Director</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- /.team-img -->
                 <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="team-block">
                        <div class="team-img">
                          <img src="images/davie-tembo.jpg" alt="">
                            <div class="team-content">
                                <h4 class="text-white mb0">Davie Tembo</h4>
                                <p class="team-meta">- Finance Director</p>
                            </div>
                            <div class="overlay-x">
                                <div class="text">
                 ...
                 <!-- <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12"> -->
                    ...
                    <!--<div class="team-block">
                        <div class="team-img">
                            ...
                            <div class="team-content">
                                <h4 class="text-white mb0">Chimango Munthali</h4>
                                <p class="team-meta">- Operations Director</p>
                            </div>
                            <div class="overlay-x">
                                <div class="text">
                ...
                <!-- /.team-img -->
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="team-block">
                        <div class="team-img">
                            <img src="images/dr-ndindi.jpg" alt="">
                            <div class="team-content">
                                <h4 class="text-white mb0">Reuben Ndindi</h4>
                                <p class="team-meta">- Director Informatics</p>
                            </div>
                            <div class="overlay-x">
                                <div class="text">
                   ...
                   <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="team-block">
                        <div class="team-img">
                            ...
                            <img src="images/soyapi-mumba.jpg" alt="">
                            <div class="team-content">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                 ...
                 <div class="team-block">
                    <div class="team-img">
                        <img src="images/patricia-khomeni.jpg" alt="">
                            <div class="team-content">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                  ...
                  <div class="team-block">
                      <div class="team-img">
                        <img src="images/fidelis-suwedi.jpg" alt="">
                          <div class="team-content">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                  ...
                  <div class="team-block">
                      <div class="team-img">
                          <img src="images/chimwemwe-mputeni.jpg" alt="">
                          <div class="team-content">
              ...
              <div class="team-block">
                  <div class="team-img">
                     <img src="images/mwatha-bwanali.jpg" alt="">
                      <div class="team-content">
            ...
            <!-- /.team-img -->
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                ...
                <div class="team-block">
                    <div class="team-img">
                        <img src="images/anastanzia-mbano.jpg" alt="">
                        <div class="team-content">
                            <h4 class="text-white mb0">Anatsanzia Mbano</h4>
                            <p class=" mb30 team-meta">- Manager</p>
                        </div>
                        <div class="overlay-x">
                            <div class="text">
            ...
            <div class="row">
                    ...
                    <!-- Created for <a href="" target="_blank">easetemplate</a>-->
              </div></div>
            </div>
        </div>
